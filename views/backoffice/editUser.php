...
<form action="controllers/editUser.php" method="POST" class="workForm" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" name="id" class="form-control" id="exampleFormControlInput1" readonly value="<?= $user->getId(); ?>">
  </div>
  <hr class="my-3">
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="psd" class="form-control" id="exampleFormControlInput3" placeholder="password" value="">
  </div>
  <hr class="my-3">
  <div class="form-group">
